...
//       let charIdx = Math.floor(Math.random() * str.length + 1); //logic for genrate password
//       console.log(`H${charIdx}`);
...
//   return (
//     <>
//       <div className="w-full max-w-md mx-auto rounded-md shadow-md  px-4 py-3 my-8 text-orange-500 bg-gray-700">
...
//             className="outline-none bg-blue-700 text-wite px-3 py-0.5 shrink-0"
//           >
//             copy
//           </button>
//         </div>
